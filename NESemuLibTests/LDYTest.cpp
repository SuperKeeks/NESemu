...
namespace NESemuLibTests
{
    ...
    public:
        ...
        TEST_METHOD(LDY)
        {
            ...
            Assert::AreEqual((uint8_t)0x33, cpu.GetYValue());
            ...
            // Zero
            cycles = cpu.ExecuteNextInstruction();
            Assert::AreEqual((uint8_t)0x0, cpu.GetYValue());
            ...
            // Negative number
            cycles = cpu.ExecuteNextInstruction();
            Assert::AreEqual((uint8_t)0xFF, cpu.GetYValue());
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Zero));
            ...
            cycles = cpu.ExecuteNextInstruction();
            Assert::AreEqual((uint8_t)0x12, cpu.GetYValue());
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Zero));
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Sign));
            ...
            cycles = cpu.ExecuteNextInstruction();
            Assert::AreEqual((uint8_t)0x66, cpu.GetYValue());
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Zero));
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Sign));
            ...
            cycles = cpu.ExecuteNextInstruction();
            Assert::AreEqual((uint8_t)0x77, cpu.GetYValue());
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Zero));
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Sign));
            Assert::AreEqual(4, cycles);
            ...
            cpu.ExecuteNextInstruction(); // LDX
            cycles = cpu.ExecuteNextInstruction();
            Assert::AreEqual((uint8_t)0x22, cpu.GetYValue());
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Zero));
            Assert::AreEqual(false, cpu.GetFlag(CPU::Flag::Sign));
            Assert::AreEqual(4, cycles);
        }
